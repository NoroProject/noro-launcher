...
CREATE TABLE IF NOT EXISTS builds (
    ...
    unmanaged_paths    JSONB NOT NULL DEFAULT '["saves/","screenshots/","options.txt","optionsof.txt","optionsshaders.txt","logs/","crash-reports/","xaero*","config/xaero*","xaerominimap*","xaeroworldmap*"]',
